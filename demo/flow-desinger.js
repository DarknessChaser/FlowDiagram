            ...
            G(go.Palette, div, // 必须是DIV元素
                {
                    ...
                    model: new go.GraphLinksModel([
                        { key: guid(), text: "开始", figure: "Circle", fill: "#4E6E7D", stepType: 1 },
                        _jsonNewStep,
                        { key: guid(), text: "结束", figure: "Circle", fill: "#4E6E7D", stepType: 4 }
                    ])
                });
